<?php
	require("db.php");
	$sql="select * from avgpricespesticides";
...
<section  class="col-sm-9 container-panel">
 ...
 <!--[/Banner]-->
     ...
     <div class="clearfix">
  	<ul class="breadcrumb"><li><a href="index.php">Home </a></li><li><a href="information.php">Info Hub</a></li><li><a href="#">PESTICIDE PRICES</a></li></ul>
 ...
 <div class="clearfix data-overview">
	<script>
					$(document).ready(function(){
								$.ajax({
									type:"POST",
									url:"setpesticidepricestable.php",
