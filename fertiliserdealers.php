<?php
	require ("db.php");
	$sql="Select * from fertilizerdealers";
...
<head>
    ...
    <title>Fertilizer Dealers Report</title>
...
<script>$(document).ready(function(){$('#prod2').addClass('active');}) ;</script>

<section class="col-sm-9 container-panel">

     <div class="clearfix">
  	<ul class="breadcrumb"><li><a href="index.php">Home </a></li><li><a href="information.php">Information Hub </a></li><li><a href="#">FERTILISER DEALERS </a></li></ul>
...
Highcharts.chart('container', {
    ...
    title: {
					text: 'Fertilizer Dealers Report'
	},
	subtitle: {
