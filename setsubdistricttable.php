...
<?php
	...
	if($_POST){
		...
		if($district=="All" && $state!="All" && $subdistrict=="All"){
			...
			$sql="select LabName as 'Lab Name',statenm as State,districtnm as District,blockNameEng as Block,Town_Village_Name as 'Town/Village',Mobile,MNTF as 'MicroNutrient Testing Facility',BTF as 'Boron Testing Facility',STF as 'Sulphur Testing Facility',Static_Mobile as 'Static/Mobile' from soiltestinglabs where StateCD=$state and DistrictCD=$district order by LabName";
		}
		else if($district!="All" && $state!="All" && $subdistrict!="All"){
			$sql="select LabName as 'Lab Name',statenm as State,districtnm as District,blockNameEng as Block,Town_Village_Name as 'Town/Village',Mobile,MNTF as 'MicroNutrient Testing Facility',BTF as 'Boron Testing Facility',STF as 'Sulphur Testing Facility',Static_Mobile as 'Static/Mobile' from soiltestinglabs where StateCD=$state and DistrictCD=$district and BlockCode=$subdistrict order by LabName";
		}
		if(isset($sql)){
