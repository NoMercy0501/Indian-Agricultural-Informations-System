...
if($getmsg > 0){
	...
	$farmer = mysqli_query($conn,"SELECT * FROM farmer WHERE farmerid='$getmsg[frm]'");
	$getfarmer = mysqli_fetch_array($farmer);
	$msg.= "<table class='table table-bordered'><tr><th style='background:#c52d2f;color:#fff;'><center>Sent From</center></th><td>".$getfarmer['firstname']." ".$getfarmer['lastname']."</td></tr>";
