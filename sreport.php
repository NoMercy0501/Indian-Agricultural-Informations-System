...
$pdf->Cell(60,10,'Seed Report');
$pdf->Cell(60,10,'Status: '.$_SESSION['status']);
$pdf->setFont('Arial','B',11);
$headers = array('No','Id Number', 'First Name', 
			'Last Name','Location', 'Seedhybrid',
			'Variety','Landsize', 'Amount');
$w = array(10,20,25,25,25,20,35,20,20);
$pdf->Ln();
...
for($j=0; $j<count($details); $j++) {
	...
	$pdf->Cell(20,7,$farmer['idno'],1,0,'C',true);
	...
	$pdf->Cell(20,7,$farmer['seedhybrid'],1,0,'C',true);
	$pdf->Cell(35,7,$farmer['variety'],1,0,'C',true);
	$pdf->Cell(20,7,$farmer['landsize'],1,0,'C',true);
	$pdf->Cell(20,7,$farmer['amount'],1,0,'C',true);
	$pdf->Ln();
}
$date = strtotime('now');
