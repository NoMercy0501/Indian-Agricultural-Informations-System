...
if($getmsg > 0){
	...
	$ad=mysqli_query($conn,"select * from admin where adminid='$getmsg[frm]'");
	$adm=mysqli_fetch_array($ad);
	$msg.= "<table class='table table-bordered'><tr><th style='background:#c52d2f;color:#fff;'><center>From</center></th><td>".$adm['firstname']." ".$adm['lastname']."</td></tr>";
	...
	$msg.= "<table class='table table-bordered'><tr><th style='background:#c52d2f;color:#fff;'><center>From</center></th><td>".$getmsg['t']."</td></tr>";
	$msg.= "<tr><th style='background:#c52d2f;color:#fff;'><center>Subject</center></th><td>".$getmsg['subject']."</td></tr></table>";
	$msg.= "<br><br><legend>Message</legend>";
	$msg.= "<div style =' word-wrap: break-word;margin:20px;text-align:left;'>";
	$msg.= $getmsg['message'];
